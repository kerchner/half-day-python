...
- `notebooks/` — the **student** versions of the workshop notebooks: all of the
  ...
  - [Part 1 Notebook](https://colab.research.google.com/github/kerchner/half-day-python/blob/main/notebooks/Python_Workshop_Part_1.ipynb){target="_blank"} - the Python language: variables,
