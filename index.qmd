...
|-----|----| ----------------------|
| **Google Colab** | In browser | Jupyter notebooks hosted by Google — nothing to install; free tier (needs a Google account) |
...
| **PyCharm** | Desktop app | Full-featured professional Python IDE (free Community edition) |
...
::: {.tip-box}
🔁 Something acting weird? **Runtime → Restart** and run the cells top-to-bottom.
:::
...
tracks = [1, 3, 4]
album  = pd.DataFrame({"song": songs, "track": tracks}) # a table
```
...
- Use **4 spaces** per level (notebooks and editors do this for you after a `:`)
- Every `for`, `while`, `if`, `else`, and `def` line ends with a **`:`**

::: {.tip-box}
💬 Comment the *why*, not the *what* — your future self is your most important collaborator.
:::
...
Repeat **while** a condition is true — when you don't have a list to walk through:
...
::: {.tip-box}
🎲 Random numbers differ every run. For a *repeatable* sequence, call `random.seed(42)` first.
:::
...
- Over 500,000 packages on **PyPI** ([pypi.org](https://pypi.org)) — the Python Package Index
...
- Official docs: [docs.python.org](https://docs.python.org/3/) · [pandas.pydata.org](https://pandas.pydata.org/docs/)
...
::: {.tip-box}
🎯 Rule of thumb: **notebooks** to explore and to tell the *story*; **scripts** for reusable building blocks and automation. Many projects use both — and **Quarto** lets a notebook become a polished report.
:::
...
- Learn **git** early — even just to keep a history of your own work
...
## Thanks! 🐍 {background-color="#306998" .divider}
...
|  |  |   |
|---|---|----------------|
| me | Python, R, etc. | [calendly.com/kerchner](https://calendly.com/kerchner)  |
| Academic Commons Data Consultants | Python, R, Statistics, SAS, Excel, etc. | [go.gwu.edu/DataConsulting](https://go.gwu.edu/DataConsulting) |
...
Notebooks: [github.com/kerchner/half-day-python](https://github.com/kerchner/half-day-python/) in the "notebooks" folder  
